...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "agents" ADD CONSTRAINT "agents_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "agents_siteId_index" ON "agents" USING btree ("siteId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "agents_userId_index" ON "agents" USING btree ("userId");--> statement-breakpoint
