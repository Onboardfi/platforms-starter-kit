    ...
    <div className="relative overflow-hidden rounded-3xl bg-neutral-800/50 backdrop-blur-md shadow-dream shine">
      ...
      <div className="relative flex items-center justify-between p-6">
        <div className="flex items-center space-x-2">
          <a href="/sites" className="text-neutral-400 hover:text-white transition-colors">Sites</a>
          <span className="text-neutral-600">/</span>
          <span className="px-3 py-1 rounded-xl bg-dream-purple/20 text-white border border-dream-purple/20 shine">
            {site.name}
          </span>
        </div>
