                  ...
                  <Card className="bg-black border border-gray-800">
                    <CardContent className="p-6">
                      {!draftNote && !draftEmail ? (
                        <div className="relative h-[600px] rounded-lg overflow-hidden bg-dark-accent-1">
                  ...
                  <Card className="bg-black border border-gray-800">
                    <CardContent className="p-6">
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-800">
                        ...
                        {/* Visualizations */}
                        <div className="mt-4 grid grid-cols-2 gap-4 h-8">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                  <Button
                    ...
                    onClick={() => window.open('https://docs.onboardfi.com', '_blank')}
                  >
                    Documentation
                  </Button>
                  <Button
                    ...
                    size="sm"
                    className="text-gray-400 hover:text-white font-mono"
                    onClick={() => window.open('https://github.com/onboardfi', '_blank')}
                  >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="font-mono text-xs border-gray-800 hover:border-white"
                >
