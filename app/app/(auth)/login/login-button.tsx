    ...
    <button
      ...
      className={`${
        loading
          ...
          : "bg-neutral-900/30 hover:bg-neutral-800"
      } w-full text-white text-sm px-4 py-2 rounded-lg flex items-center justify-center shine shadow-dream space-x-2 transition-all duration-300`}
    >
      {loading ? (
